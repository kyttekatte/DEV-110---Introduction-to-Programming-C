...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        // Use a for loop to repeat the game for each round
        ...
        // Print a closing message after all rounds finish
        // Example: "Thanks for playing!"
        Console.WriteLine("\nThanks for playing!");

        // Example: Console.WriteLine($"\nRound {round} of {rounds}");

        // Generate a secret number in the range 1..max (inclusive)
        ...
        // Initialize guess tracking variables (inside the for loop)
        ...
        // Read a guess and validate that it is a number (inside the while loop)
        ...
        // Update guessCount and provide feedback (inside the while loop)
